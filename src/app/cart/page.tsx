...
export default function CartPage() {
    ...
    // Handler untuk menghapus item sudah menggunakan removeItem dari cartStore
                                ...
                                <div key={item.id} className="p-4 flex flex-col sm:flex-row gap-4">
                                    ...
                                    <div className="flex-1 flex flex-col">
                                        <div className="flex justify-between">
                                            <Link href={`/products/${item.productId}`} className="text-lg font-medium hover:text-primary">
                                                {item.name}
                                            </Link>
                                            <button
                                        ...
                                        <p className="text-sm text-base-content/70">Seller: {item.sellerName}</p>
