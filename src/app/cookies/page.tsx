        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              ...
              allowing websites to remember your preferences and understand how
              you use their site.
            </p>
            ...
            <p>
              At Sustainable Community Market, we use cookies for various
              purposes, including:
            </p>
            <ul className="list-disc pl-6 mt-2 space-y-2">
              ...
              <li>
                ...
                features. For example, they may remember your login details or
                language preferences.
              </li>
              <li>
                <strong>Performance Cookies:</strong> These cookies collect
                information about how you use our website, such as which pages
                you visit most often. They help us understand how visitors
                interact with our website, enabling us to continually improve
                it.
              </li>
              <li>
            ...
            <p>
              These are cookies that are set by our website directly. They are
            ...
            <p>
              These are cookies set by third parties that we partner with. They
              may be used for analytics, advertising, or social media
              integration. For example, we use Google Analytics to help us
              understand how visitors engage with our site.
            </p>
            ...
            <p>
              ...
              browser. They help our website recognize you as you navigate
              between pages.
            </p>
            <h3 className="text-xl font-semibold mt-4 mb-2">
              Persistent Cookies
            ...
            <p>
              ...
              until you delete them manually. They help our website remember
            ...
            <p>
              ...
              to browser, and from version to version. You can obtain up-to-date
              information about blocking and deleting cookies via the support
            ...
            <p className="mt-4">
              ...
              of our website. For example, you may not be able to access certain
              areas of our site or you may be logged out of your account.
            </p>
            ...
            <p className="mt-2">
              <strong>Email:</strong> privacy@sustainablecommunitymarket.com
              <br />
              <strong>Phone:</strong> +62 123 4567 890
              <br />
              <strong>Address:</strong> Jl. Melawai Raya No. 45, Blok M, Jakarta
              Selatan, Indonesia
            </p>
          </div>
        </div>
