...
export default function CheckoutPage() {
    ...
    }, [isLoggedIn, cartItems.length, router, orderComplete]);
        ...
        return (
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-2xl mx-auto bg-base-100 rounded-lg shadow-sm p-8 text-center">
                    ...
                    <p className="mb-6">Thank you for your order. Your order number is <span className="font-bold">{orderId}</span>.</p>

                    <div className="mb-8 p-4 bg-base-200 rounded-lg">
                        <p className="text-sm">Payment instructions have been sent to your email. Please complete the payment within 24 hours to process your order.</p>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-base-100 rounded-lg shadow-sm p-6 mb-6">
                        ...
                        <div className="space-y-4">
                            <div className="form-control">
                                ...
                                />
                                {formErrors.fullName && <span className="text-error text-sm mt-1">{formErrors.fullName}</span>}
                            </div>
                            ...
                            <div className="form-control">
                                ...
                                <textarea
                                    ...
                                    onChange={handleAddressChange}
                                    className={`textarea textarea-bordered w-full ${formErrors.address ? 'textarea-error' : ''}`}
                                    placeholder="Complete shipping address"
                                    rows={3}
                                ></textarea>
                                {formErrors.address && <span className="text-error text-sm mt-1">{formErrors.address}</span>}
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="form-control">
                                    ...
                                    <input
                                        ...
                                        placeholder="City"
                                    />
                                    {formErrors.city && <span className="text-error text-sm mt-1">{formErrors.city}</span>}
                                </div>
                                ...
                                <div className="form-control">
                                    ...
                                    <input
                                        ...
                                        onChange={handleAddressChange}
                                        className={`input input-bordered w-full ${formErrors.postalCode ? 'input-error' : ''}`}
                                        placeholder="Postal code"
                                    />
                                    {formErrors.postalCode && <span className="text-error text-sm mt-1">{formErrors.postalCode}</span>}
                                </div>
                            </div>
                            ...
                            <div className="form-control">
                                ...
                                />
                                {formErrors.phone && <span className="text-error text-sm mt-1">{formErrors.phone}</span>}
                            </div>
                        </div>
                    </div>
                                ...
                                {paymentMethod.type === "bank_transfer" && (
                                    <div className="mt-2 pl-7">
                                        <select
                                            ...
                                            onChange={handlePaymentChange}
                                            className={`select select-bordered w-full ${formErrors.payment ? 'select-error' : ''}`}
                                        >
                                        ...
                                        {formErrors.payment && <span className="text-error text-sm mt-1">{formErrors.payment}</span>}
                                    </div>
                                )}
                            </div>
                ...
                <div className="lg:col-span-1">
                    <div className="bg-base-100 rounded-lg shadow-sm p-6 sticky top-20">
                        ...
                        <div className="mb-4">
                            <div className="text-sm text-base-content/70 mb-2">Item ({cartItems.reduce((acc, item) => acc + item.quantity, 0)}):</div>
                                ...
                                {cartItems.map((item) => (
                                    <div key={item.id} className="flex gap-3">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="text-xs text-base-content/70">{item.quantity} x {formatPrice(item.price)}</div>
                                        </div>
