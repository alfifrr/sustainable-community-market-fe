      ...
      <div className="bg-base-300 rounded-lg shadow-lg p-4 md:p-6 transition-shadow hover:shadow-xl">
        <div className="flex flex-col sm:flex-row items-center sm:space-x-6 space-y-4 sm:space-y-0">
          ...
          <div className="text-center sm:text-left">
            ...
            <div 
              ...
              role="status"
              aria-label={`User verification status: ${user.is_verified ? "Verified" : "Not verified"}`}
            >
        ...
        <div className="mt-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              <p id="member-since-label" className="text-sm text-primary font-medium mb-1">
                Member since
              </p>
            ...
            >
              <p id="last-activity-label" className="text-sm text-primary font-medium mb-1">
                Last activity
              </p>
              <p className="font-medium text-base-content">
                {user.last_activity
